...
fn main() {
    ...
    .with_grad_clip(1.0)
    .with_batch_size(16) // Showcase new setter: set training batch size
    .with_eval_batch_size(16); // Showcase new setter: set evaluation batch size
    ...
    let config = RaceConfig::builder()
        ...
        .set_csv_export(true) // Exports the lossless long-form metrics.csv record
